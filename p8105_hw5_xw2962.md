...
```
    ...
    ##     <dbl>   <dbl>   <dbl> <lgl>   
    ##  1 -0.394   0.678       0 FALSE   
    ##  2  1.11    0.275       0 FALSE   
    ##  3 -0.536   0.508       0 FALSE   
    ##  4 -0.159   0.851       0 FALSE   
    ##  5  0.993   0.346       0 FALSE   
    ##  6  0.528   0.627       0 FALSE   
    ##  7 -0.504   0.607       0 FALSE   
    ##  8 -1.28    0.199       0 FALSE   
    ##  9 -0.540   0.600       0 FALSE   
    ## 10 -1.33    0.156       0 FALSE   
    ## # ℹ 34,990 more rows
