...
```
    ...
    ##      <dbl>   <dbl>   <dbl> <lgl>   
    ##  1  1.19    0.267        0 FALSE   
    ##  2 -0.0238  0.975        0 FALSE   
    ##  3 -1.47    0.107        0 FALSE   
    ##  4  1.82    0.0564       0 FALSE   
    ##  5  0.183   0.846        0 FALSE   
    ##  6 -1.03    0.314        0 FALSE   
    ##  7  0.761   0.361        0 FALSE   
    ##  8  0.453   0.617        0 FALSE   
    ##  9 -1.42    0.159        0 FALSE   
    ## 10  1.20    0.171        0 FALSE   
    ## # ℹ 34,990 more rows
