...
```
    ...
    ##     <dbl>   <dbl>   <dbl> <lgl>   
    ##  1  1.73   0.0662       0 FALSE   
    ##  2 -0.283  0.781        0 FALSE   
    ##  3 -0.977  0.247        0 FALSE   
    ##  4 -0.340  0.698        0 FALSE   
    ##  5  0.619  0.466        0 FALSE   
    ##  6  1.71   0.0449       0 TRUE    
    ##  7 -0.172  0.861        0 FALSE   
    ##  8  0.290  0.765        0 FALSE   
    ##  9 -1.33   0.137        0 FALSE   
    ## 10  0.375  0.685        0 FALSE   
    ## # ℹ 34,990 more rows
...
effect size. This could be due to a Type II error, which occurs when a
false null hypothesis is not rejected. As the true mean (μ) increases,
the rate of Type II error decreases, enhancing the test’s power. This
results in a greater likelihood of rejecting the null hypothesis and
yields a more precise estimation of the μ value.
