...
```
    ...
    ##     <dbl>   <dbl>   <dbl> <lgl>   
    ##  1 -0.757  0.445        0 FALSE   
    ##  2  0.335  0.693        0 FALSE   
    ##  3  0.556  0.557        0 FALSE   
    ##  4 -1.36   0.196        0 FALSE   
    ##  5 -0.450  0.620        0 FALSE   
    ##  6  1.29   0.180        0 FALSE   
    ##  7 -1.54   0.0963       0 FALSE   
    ##  8 -1.68   0.0829       0 FALSE   
    ##  9 -0.418  0.549        0 FALSE   
    ## 10  0.107  0.923        0 FALSE   
    ## # ℹ 34,990 more rows
